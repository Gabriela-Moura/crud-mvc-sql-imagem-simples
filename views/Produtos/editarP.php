...
Preco:
<input type="decimal" name="preco" value="<?php echo $produto['preco']; ?>"><br><br>
Margem:
<input type="decimal" name="margem" value="<?php echo $produto['margem']; ?>"><br><br>
Data Cadastro:
<input type="text" name="data_cadastro" value="<?php echo $produto['data_cadastro']; ?>"><br><br>
Status:
